...
|---------|-------------------|----------------------------|
| 1. Fruit Battery | [Download](session-01-fruit-battery-experiment.pdf) | [Download](session-01-fruit-battery-lecture-notes.pdf) |
...
**Experiment packet:** session overview, preparation, materials checklist, full experiment procedure, and shared safety notes.

**Lecture & instructor notes:** session overview, lecture talking points, instructor deep-dive notes, and preparation reminders.
