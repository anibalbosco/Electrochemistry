...
| **Reduction** | Gain of electrons | 2H⁺ + 2e⁻ → H₂ |
...
> **Common confusion:** In electrolysis (Session 2+), the anode is connected to the **positive** terminal of the power supply. In a **battery** (galvanic cell), the anode is **negative**. Always ask: *spontaneous cell or driven cell?*
...
![Electron and ion paths in a fruit cell](../../assets/figures/session1-fruit-cell.svg)

*See [experiment.md](experiment.md) for build steps and the series-cell schematic.*
...
- 3 lemons × ~0.9 V ≈ 2.7 V — enough to try an LED (often needs ~2 V+)
